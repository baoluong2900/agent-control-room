...
const taskSeeds: TaskBlueprint[] = [
  {
    ...
    kind: "investigate",
    accent: "blue",
    files: ["packages/contracts", "apps/desktop/src/preload/preload.ts", "apps/desktop/src/main/ipc/register-ipc.ts"],
  ...
  },
  {
    ...
    kind: "investigate",
    accent: "cyan",
    files: ["apps/desktop/src/main/processes/agent-process-manager.ts", "apps/desktop/src/renderer/agents/AgentTerminal.tsx", "apps/desktop/src/main/agents/commands.ts"],
  ...
  },
  {
    ...
    kind: "analyze",
    accent: "green",
    files: ["README.md", "apps/desktop/src/main", "apps/desktop/src/renderer"],
  ...
  },
  {
    ...
    kind: "deploy",
    accent: "orange",
    files: ["forge.config.ts", "apps/desktop/vite.renderer.config.ts", "package.json"],
  ...
  },
  {
    ...
    kind: "review",
    accent: "red",
    files: ["apps/desktop/src/main/main.ts", "apps/desktop/src/main/windows", "apps/desktop/src/renderer/App.tsx"],
