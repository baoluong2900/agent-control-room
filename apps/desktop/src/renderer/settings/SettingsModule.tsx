    ...
    <main className="settings-page">
      <section className="settings-hero">
        <div className="settings-hero-copy">
          ...
          <h1>App account and AI providers</h1>
          <p>
            App sign-in is kept separate from AI account links. The desktop app owns project state, while provider
            records stay local on this machine.
          </p>
        </div>
      ...
      <section className="settings-grid">
        <article className="settings-panel settings-identity-panel">
          <header>
            <div>
              <h2>App account</h2>
              <p>Used for projects, tasks, and sync metadata.</p>
            </div>
            <LogIn size={16} />
          </header>
          ...
          <div className="settings-panel-actions">
            <button className="settings-action settings-action-secondary" onClick={() => void saveIdentity("signed-in")}>
              {savingIdentity ? <Loader2 size={14} className="spin" /> : <Save size={14} />}
              Save profile
            </button>
            <button className="settings-action settings-action-ghost" onClick={() => void saveIdentity("signed-out")}>
              Sign out
            </button>
          </div>
        </article>
