import { Clock3, FolderOpen, GitBranch, History, RefreshCw, Terminal } from "lucide-react";
        ...
        <section className="projects-list-panel">
          ...
          <div className="projects-list">
            {recentProjects.map((item) => (
              <button
                key={item.path}
                className={project?.path === item.path ? "selected" : ""}
                onClick={() => void onSelectRecent(item)}
              >
                <span>
